...
* [Enabling OIDC authentication](admin-guide/oidc.md)
...
* [Local authentication](admin-guide/local_authn.md)
* [Configuration reference](admin-guide/configuration_reference.md#configuration-reference)
    ...
    - [Access token contents configuration](admin-guide/configuration_reference.md#access-token-contents-configuration)
    - [Organization configuration](admin-guide/configuration_reference.md#organization-configuration)
